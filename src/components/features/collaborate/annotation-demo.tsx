						...
						<React.Fragment key={index}>
							...
							{index === 0 && (
								<span className="relative group">
									<span className="bg-yellow-300 px-1 text-black group-hover:bg-yellow-400 group-hover:underline transition-all">
										{highlightedText}
									</span>
									...
									<div className="absolute top-[-220%] left-[110%] w-96 p-4 rounded-lg shadow-lg backdrop-filter backdrop-blur-lg bg-white/10 text-foreground opacity-95 group-hover:opacity-100 group-hover:scale-[1.01] transition-all">
										...
										<div className="mt-4 relative">
											...
											/>
											<button className="absolute right-2 top-1/2 transform -translate-y-1/2 p-2 bg-blue-500 text-white rounded-full hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 transition-all duration-300">
